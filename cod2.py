...
# Напишите программу, в которой пользователь вводит фильм. Если кинокартина есть в перечне, то добавляется в список любимых. Если её нет,то выводится ошибка.
# Вконце выведите весь список любимых фильмов

#  Пример:
#  Сколько фильмов хотитед обавить? 3
...
for film in range(movies_count):
    movie = (input(f"Введите фильм: "))
    if movie in films:
        myfilms.append(movie)
    else: 
        print(f"Простите, фильма {movie} у нас нет.")

print('Ваши любимые фильмы: ' ,*myfilms)
